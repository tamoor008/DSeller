...
// Type for numeric fields only (excludes boolean and string fields)
type NumericField = 
  | 'darazCommission'
  | 'paymentHandlingFee'
  | 'sellingPrice'
    ...
    <section className={styles.inputCard}>
      ...
      <div className={styles.formGrid}>
        {FIELD_CONFIG.map(({ label, field, step }) => {
          ...
          // Convert to string for input, handle empty string case
          const inputValue = fieldValue === '' || fieldValue === undefined ? '' : String(fieldValue);
