        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
            <IndividualDataComp
              ...
              onPress={() => navigate('/app/orders/pending')}
            />
            <IndividualDataComp
              loader={darazOrdersLoader}
              data={readyToShipOrdersCount}
              label={AppStrings.readyToShipOrders}
              onPress={() => navigate('/app/orders/ready-to-ship')}
            />
            <IndividualDataComp
              loader={false}
              data={deliveredOrdersCount}
              label={AppStrings.deliveredOrdersToday}
              onPress={() => navigate('/app/orders/delivered')}
            />
            <IndividualDataComp
              loader={false}
              data={failedOrdersCount}
              label={AppStrings.failedOrdersToday}
              onPress={() => navigate('/app/orders/failed')}
            />
          </div>
          <WeeklyReportComp
            onPress={() => navigate('/app/weekly-report')}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
            ...
            <IndividualValueComp
              ...
              onPress={() => navigate('/app/packaging')}
            />
          </div>
        </div>
      </div>
